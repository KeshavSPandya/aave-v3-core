...
library Errors {
  ...
  // Error 7 and 8 were missing, adding them back
  string public constant ADDRESSES_PROVIDER_NOT_REGISTERED = '7'; // 'Pool addresses provider is not registered'
  string public constant INVALID_ADDRESSES_PROVIDER_ID = '8'; // 'Invalid id for the pool addresses provider'
  string public constant NOT_CONTRACT = '9'; // 'Address is not a contract'
  string public constant CALLER_NOT_POOL_CONFIGURATOR = '10'; // 'The caller of the function is not the pool configurator'
  string public constant CALLER_NOT_ATOKEN = '11'; // 'The caller of the function is not an AToken'
  // CALLER_NOT_KTOKEN will be 12
  string public constant CALLER_NOT_KTOKEN = '12'; // Caller of function is not kToken
  string public constant INVALID_ADDRESSES_PROVIDER = '13'; // 'The address of the pool addresses provider is invalid'
  string public constant INVALID_FLASHLOAN_EXECUTOR_RETURN = '14'; // 'Invalid return value of the flashloan executor function'
  string public constant RESERVE_ALREADY_ADDED = '15'; // 'Reserve has already been added to reserve list'
  string public constant NO_MORE_RESERVES_ALLOWED = '16'; // 'Maximum amount of reserves in the pool reached'
  string public constant EMODE_CATEGORY_RESERVED = '17'; // 'Zero eMode category is reserved for volatile heterogeneous assets'
  string public constant INVALID_EMODE_CATEGORY_ASSIGNMENT = '18'; // 'Invalid eMode category assignment to asset'
  string public constant RESERVE_LIQUIDITY_NOT_ZERO = '19'; // 'The liquidity of the reserve needs to be 0'
  ...
  string public constant NO_OUTSTANDING_STABLE_DEBT = '42'; // 'User does not have outstanding stable rate debt on this reserve'
  string public constant NO_OUTSTANDING_VARIABLE_DEBT = '43'; // 'User does not have outstanding variable rate debt on this reserve'
  ...
  // Note: Error codes 80-82 were already used before, I'm removing them from here to avoid conflict.
  // string public constant CALLER_NOT_KTOKEN = '80'; // Caller of function is not kToken
  // string public constant ADDRESSES_PROVIDER_NOT_REGISTERED = '81'; // Addresses provider is not registered
  // string public constant INVALID_ADDRESSES_PROVIDER_ID = '82'; // Invalid id for the V3 addresses provider
}
